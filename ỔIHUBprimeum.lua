...
Toggle = Tabs.Settings:AddToggle("MyToggle", {Title = "Fast130785805 Attack V2", Description = "Better than old attack recommended", Default = true })
Toggle:OnChanged(function(Value)
    Fast_Attack = Value
    saveSettings()
end) 
...
local function ChangeModeFastAttack(SelectFastAttackMode)
	...
	elseif SelectFastAttackMode == "Fast Attack" then
		FireCooldown = 0.07
	elseif SelectFastAttackMode == "haidepzai Fast" then
		FireCooldown = 0
	end
end
...
doughsex = Tabs.Main:AddToggle("doughsex", {
    Title = "đánh quái katacuri",
    Description = "tự động farm 500 con và chiệu hồi + muchbang kata",
...
spawn(function()
  while wait() do
    ...
    Toggle = Tabs.stack:AddToggle("MyToggle", {Title = "đánh nhà máy", Default = _G.AutoFactory })
...
spawn(function()
 ...
 occhochest = Tabs.stack:AddToggle("occhochest", {Title = "nhăt rương┊bay", Default = AutoFarmChest})
...
spawn(function()
 ...
 spawn(function()
    ...
    Toggle = Tabs.stack:AddToggle("MyToggle", {Title = "tự động lấy lưỡi hái ", Default = _G.AutoFarmBossHallow })
    Toggle:OnChanged(function(Value)
    ...
    local CoNguoiDoiGietTao = Tabs.Main:AddToggle("MyToggle", {Title = "Farm nguyên liệu", Default = _G.AutoFarmMaterial })
...
Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Farm vật chất kì dị", Default = _G.AutoEctoplasm })
    Toggle:OnChanged(function(Value)
    ...
    Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "bắt đầu đánh boss", Default = _G.AutoFarmBoss })
    Toggle:OnChanged(function(Value)
...
Toggle = Tabs.RC:AddToggle("MyToggle", {Title = "Farm và bật tộc v4", Default = _G.Auto_Bone })
    Toggle:OnChanged(function(Value)
        _G.Auto_Bone = Value
        saveSettings()
    end)
            ...
            while wait() do 
                if _G.AutoSuperhuman then
                    ...
                    if game.Players.LocalPlayer.Backpack:FindFirstChild("Black Leg") or game.Players.LocalPlayer.Character:FindFirstChild("Black Leg") or game.Players.LocalPlayer.Backpack:FindFirstChild("Electro") or game.Players.LocalPlayer.Character:FindFirstChild("Electro") or game.Players.LocalPlayer.Backpack:FindFirstChild("Fishman Karate") or game.Players.LocalPlayer.Character:FindFirstChild("Fishman Karate") or game.Players.LocalPlayer.Backpack:FindFirstChild("Dragon Claw") or game.Players.LocalPlayer.Character:FindFirstChild("Dragon Claw") then
                        ...
                        if game.Players.LocalPlayer.Backpack:FindFirstChild("Dragon Claw") and game.Players.LocalPlayer.Backpack:FindFirstChi
